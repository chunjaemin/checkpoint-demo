...
import { useEditDateStore } from '@/features/calendar/personal';
import { useUserStore } from '@/scripts/store/userStore';
import Feather from '@expo/vector-icons/Feather';
import Modal from 'react-native-modal';
import DailyScheduleModalContent from '@/features/calendar/personal/ui/DailyScheduleModalContent';
...
export default function PersonalMonth() {
    ...
    const handlePageSelected = useCallback((e: any) => {
        ...
        // 락(scrollEnabled=false) 대신 가드(ref)로 중복 전환만 차단
        ...
        setTimeout(() => {
            pagerRef.current?.setPageWithoutAnimation(1);
            // 무거운 렌더에서 InteractionManager가 늦어지는 문제를 피하기 위해
            // 짧은 지연 후 가드만 해제
            setTimeout(() => {
