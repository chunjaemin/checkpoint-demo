...
import WeeklyGrid from '@/widgets/calendar/team/ui/WeeklyGrid';
...
type Props = {
  ...
  setSpaceModalVisible: React.Dispatch<React.SetStateAction<boolean>>;
  hours: number[];
  displayDate: Dayjs;
    ...
    <View style={styles.page}>
      ...
      <ScrollView contentContainerStyle={styles.scheduleGrid} horizontal={false}>
        <View style={{ flexDirection: 'row' }}>
          <View style={{ width: TIME_LABEL_WIDTH }}>
            {hours.map((h: number, rowIdx: number) => {
