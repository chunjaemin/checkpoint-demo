...
import { useEditDateStore } from '@/features/calendar/team';
...
import { indexSchedulesByMonth, ByMonth } from '@/entities/schedule';

type Schedule = React.ComponentProps<typeof DailyScheduleModalContent>['dailySchedules'][number];
type MonthScheduleMap = Record<string, Schedule[]>;
...
export default function PersonalMonth() {
    ...
    const schedulesByMonth: ByMonth<Schedule> = useMemo(() => indexSchedulesByMonth(schedules), [schedules]);
