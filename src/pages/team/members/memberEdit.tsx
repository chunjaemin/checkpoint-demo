...
export default function TeamUserDetailEdit() {
    ...
    const [deductTax, setDeductTax] = useState(false);     // 🔹 세금 적용 여부
    const [deductions, setDeductions] = useState('4대 보험'); // 🔹 선택된 세금 종류
    ...
    useEffect(() => {
        ...
        if (foundMember) {
            ...
            setDeductTax(!!foundMember.deductions);                      // 🔹 세금 적용 여부
            setDeductions(foundMember.deductions || '4대 보험');        // 🔹 세금 종류
        }
    }, [user, memberId]);
        ...
        const updatedMembers = teamSpace.members.map((m) =>
            m.id === memberId
                ? {
                    ...
                    deductions: deductTax ? deductions : '',              // 🔹 저장에 포함
                }
                : m
        );
                ...
                <View style={styles.card}>
                    ...
                    {deductTax && (
                        <View style={[styles.row, { marginTop: 4 }]}>
                            <Text style={styles.label}>세금 종류</Text>
                            <View style={{ width: 150 }}>
                                <Picker
                                ...
                                >
                                    ...
                                    <Picker.Item label="4대 보험" value="4대 보험" />
                                </Picker>
                            </View>
                        </View>
                    )}
